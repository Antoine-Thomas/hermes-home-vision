...
Voici la synthèse de veille hebdomadaire (10/09/2026 - 17/09/2026).

## 1) Agents autonomes

- **From Language Models to World-Acting Systems** (10/09/2026, [arXiv:2609.04894](https://arxiv.org/abs/2609.04894)) : Analyse approfondie sur l'état de l'agentique AI, soulignant que l'expansion des interfaces d'action dépasse encore la capacité de récupération robuste ou de vérification, ce qui incite à la prudence. *Impact : À surveiller*.
- **Hermes Agent v2026.9.11** (11/09/2026, [GitHub](https://github.com/NousResearch/hermes-agent)) : Mise à jour corrective améliorant la fiabilité des agents autonomes (scheduling, délégation, MCP). *Impact : Impact direct*.

## 2) MLOps

- Aucune actualité actionnable majeure détectée cette semaine concernant le parc (Windows 11, RTX 3070 Ti 8 Go, pipelines vidéo).

***

Le document a été créé dans le notebook « veille » :
- **ID du document :** `20260917143521-sjg71w8`
