# Cron Job: veille-hebdo

**Job ID:** dc15c35183aa
**Run Time:** 2026-09-17 15:03:12
**Schedule:** 0 8 * * 1
...
Voici la synthèse hebdomadaire de veille technologique (10-17 Septembre 2026) :

### Veille Hebdomadaire

#### 1. Agents Autonomes
* **Hermes Agent v2026.9.11 (11/09/2026)** - [Source](https://newreleases.io/project/github/NousResearch/hermes-agent/release/v2026.9.11)
  * Ce correctif stabilise la base de données (`state.db`) et améliore la gestion des erreurs liées au moteur de recherche plein texte.
  * *Impact : Direct* (indispensable pour la stabilité du parc).

#### 2. MLOps
* **Secure AI Gateway avec MCP centralisé (11/09/2026)** - [Source](https://www.truefoundry.com/blog/mlops-tools)
  * Introduction de solutions de passerelles sécurisées pour la gouvernance et le contrôle des flux d'inférence LLM via MCP.
  * *Impact : À surveiller* (pertinent pour la sécurisation des pipelines).
* **LiteLLM vs Vercel AI Gateway (10/09/2026)** - [Source](https://www.truefoundry.com/blog/litellm-vs-vercel-ai-gateway)
  * Comparaison des solutions de gouvernance pour les équipes d'ingénierie IA, utile pour le choix d'outils de routage/gestion d'API.
  * *Impact : À surveiller* (pertinent pour la gestion des tokens).

---
*Ce rapport a été enregistré dans le notebook « veille » (ID: 20260915170851-ricqsr6) sous l'identifiant de document suivant : **20260917150308-gzub3d1**.*
