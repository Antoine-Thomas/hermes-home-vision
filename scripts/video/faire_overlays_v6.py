# -*- coding: utf-8 -*-
"""Incrustations du volet 6 : carton de titre, schema d'architecture, snippet OpenRouter, CTA v1.3.

Conventions du projet (volet 4/5) : PNG 1920x1080 RGBA dans un dossier d'overlays,
horodatage dans un JSON {ecran, start, end}, polices Windows, aucun sous-titre.
...
OUT = r"C:\Users\searc\AppData\Local\hermes\data\video_youtube\overlays_v6"
W, H = 1920, 1080
...
def carton_titre():
    ...
    d.text((170, 330), "Jev  +  Hermes  +  LLM Wiki", font=police("titre", 96), fill=C_TITRE)
    d.text((170, 470), "Le second cerveau qui se compile tout seul", font=police("texte", 46), fill=C_TEXTE)
    d.text((170, 560), "6e edition  \u00b7  Hermes 1.3 Psychopomp", font=police("gras", 40), fill=C_ACCENT)
    logo = os.path.join(r"C:\Users\searc\AppData\Local\hermes\data\video_youtube", "hermes_logo_icon.png")
    ...
    im.save(os.path.join(OUT, "titre_intro_v6.png"))
    return "titre_intro_v6.png"
