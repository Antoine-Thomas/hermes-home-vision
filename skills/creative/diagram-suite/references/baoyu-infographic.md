<!-- Source: creative/baoyu-infographic/SKILL.md — migrated to umbrella diagram-suite on 2026-09-10 -->
...
Full definitions: `references/baoyu-infographic/layouts/<layout>.md`
...
Full definitions: `references/baoyu-infographic/styles/<style>.md`
...
**Load references**: Read `references/baoyu-infographic/analysis-framework.md` from this skill.
...
See `references/baoyu-infographic/analysis-framework.md` for detailed format.
...
See `references/baoyu-infographic/structured-content-template.md` for detailed format.
...
**Load references**: Read the selected layout from `references/baoyu-infographic/layouts/<layout>.md` and style from `references/baoyu-infographic/styles/<style>.md`.

Combine:
1. Layout definition from `references/baoyu-infographic/layouts/<layout>.md`
2. Style definition from `references/baoyu-infographic/styles/<style>.md`
3. Base template from `references/baoyu-infographic/base-prompt.md`
...
- `references/baoyu-infographic/analysis-framework.md` — Analysis methodology
- `references/baoyu-infographic/structured-content-template.md` — Content format
- `references/baoyu-infographic/base-prompt.md` — Prompt template
- `references/baoyu-infographic/layouts/<layout>.md` — 21 layout definitions
- `references/baoyu-infographic/styles/<style>.md` — 21 style definitions
